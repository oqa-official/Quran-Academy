...
export default function RegisterPage() {
    ...
    return (
        <div className="relative min-h-screen flex justify-center items-center px-2 bg-gray-50">
            ...
            <div className="w-full max-w-4xl my-20 bg-white text-center rounded-2xl p-6 relative z-10 shadow-md">
                <h2 className="text-start font-semibold mb-4">Register As Student</h2>
                <StudentRegisterForm/>
