...
// export default function StepTwo({ formData, setFormData, goBack, handleSubmit }: any) {
...
//       // Always one student if it's "for myself"
//       setStudents([formData.students?.[0] || emptyStudent()]);
//     } else {
//       // If "for someone else", respect studentCount
...
//       }
//     }
//   }, [formData.studentCount, formData.forWhom ]);
...
//   const saveAndSubmit = () => {
//     setFormData({ ...formData, students, studentCount: students.length });
//     handleSubmit();
//   };

//   return (
//     <FormWrapper title="Fill Student Details" step={2} totalSteps={2} hideProgress>
//       <div className="space-y-6">
//         {formData.forWhom  === "myself" ? (
//           // ✅ Single form (no accordion, no add/remove)
//           <StudentForm
//             basePrice={20}
//             index={0}
//             data={students[0]}
...
//                               <AlertDialogAction onClick={() => removeStudent(i)}>
//                                 Remove
//                               </AlertDialogAction>
//                             </AlertDialogFooter>
//                           </AlertDialogContent>
