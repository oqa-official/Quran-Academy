...
const fallbackCourses: Course[] = [
  {
    ...
    title: "Quran Basics",
    price: 25,
    overview: { summary: "This Quran Academy presents this course exclusively designed for beginners. It covers the fundamentals of reading and reciting the Holy Quran with proper pronunciation. Students will gradually learn Arabic alphabets, Tajweed rules, and fluency in recitation. The course also provides essential Islamic teachings to help learners strengthen their understanding of faith." },
