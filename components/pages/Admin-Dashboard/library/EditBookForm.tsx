...
//     return (
//         <div className="fixed inset-0 bg-[#00000069] flex items-center justify-center z-[100]">
  ...
  return (
    <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-[99] max-md:px-3">
     <div className="rounded-md overflow-hidden">
        ...
        <form
          onSubmit={handleSubmit}
          className="bg-white dark:bg-[#122031] text-foreground p-6 rounded-lg shadow-lg max-h-[90vh] overflow-y-auto"
        >
          {/* Close button */}
          <CircleX
          ...
          <input
            type="text"
            required
            className="w-full p-2 border rounded dark:bg-[#122031] text-foreground"
            value={form.name}
            onChange={(e) => setForm({ ...form, name: e.target.value })}
          />
          ...
          <textarea
            className="w-full p-2 border rounded dark:bg-[#122031] text-foreground min-h-[80px]"
            value={form.description}
            onChange={(e) => setForm({ ...form, description: e.target.value })}
          />
          ...
          <div className="mt-3">
            ...
            <label className="text-sm font-medium block mt-1">
              Replace PDF
            </label>
            <div className="flex items-center gap-2 w-full p-2 border rounded">
              <UploadCloud />
