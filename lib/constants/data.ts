...
import { BookOpen, DollarSign, DollarSignIcon, Laptop, LayoutDashboard, Library, LibraryBig, MailCheck, MailOpen, Phone, Settings, User, UserLock, UserRoundCheck, Users, UsersRound } from "lucide-react";
...
export const NAV_DATA_ADMIN: NavSection[] = [
  {
    ...
    items: [
      ...
      { title: "Inquire", url: "/admin_dashboard/inquire", icon: MailOpen },
       ...
       { title: "Fee Status", url: "/admin_dashboard/fee-status", icon: DollarSignIcon },
       {
        title: "Library",
        icon: LibraryBig,
        items: [
...

       {
        ...
        items: [
          ...
          { title: "Class Reminders", url: "/admin_dashboard/emails/class-reminder", icon: User },
          { title: "Fee Reminders", url: "/admin_dashboard/emails/fee-reminder", icon: User },
          { title: "Onboarding Reminder", url: "/admin_dashboard/emails/onboarding-reminder", icon: User },
